...
export default function AppraisalForm({history})
{
   ...
   // const {appraisal_id,emp_name}= route.params;  
    ...
    React.useEffect(
        ...
        ()=> {
                         localStorage.getItem ('showOrNot_AppraisalForm_At_Appraiser')=='flase'?history.push('/home'):null;    
                ...
                fetch(withQuery(ApiInfo.baseUrlForWeb+ApiInfo.getAppraisalData,
                                { 
                                  "appraisal_id":localStorage.getItem('appraisal_id')
                                }
                               ), 
                { method:'GET', 
                            ...
                            <View style={{flexDirection:'row', }}>           
                                ...
                                <View style={{marginHorizontal: responsiveWidth(3),
                                  ...
                                  <Text style={{fontWeight:'500'}}>
                                    <Text>
                                      Home / </Text> 
                                    <Text style={{color:'#F15A25'}}>Appraiser Appraisal Form</Text>
                                  </Text>
                                                                        ...
                                                                        meta
                                                                                ...
                                                                                >
                                                                                    ...
                                                                                    <RNPickerSelect   {...field}
                                                                                                      ...
                                                                                                      onValueChange={ (value )=> {
                                                                                                              setRatings(value) 
                                                                                                              setFieldValue(`prev_appraisal_targets[${index}].appraiser_rate`,selectedRatings )
                                                                ...
                                                                <View>
                                                                  ...
                                                                  <View style={{justifyContent:'space-between',flexDirection:'row',paddingVertical:responsiveHeight(3)}}>   
                                                                        ...
                                                                        <Button  
                                                                                ...
                                                                                onPress={() => {
                                                                                  arrayHelpers.push({ target: '',objectives_id:'' })
