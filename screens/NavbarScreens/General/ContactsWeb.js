...
export default function ContactsWeb(){
        ...
        React.useEffect(() => { 
                              // localStorage.getItem('password')==null?navigation.navigate('Login'):null
                                ...
                                fetch(ApiInfo.baseUrlForWeb+ApiInfo.contactsEndpoint,
                                              {
                                                method:'GET', 
                                                headers: {
        ...
        const dataSource1 = [
            {
              name: StaticWordsWeb.ContactsPage.empName_Header, 
              p_contact_num:StaticWordsWeb.ContactsPage.contactnumber_Header,
              //marginTop:'0%', 
         ...
         const renderItem = ({ item,index}) => (
                ...
                >
                    ...
                    <ListItem.Title style={{ 
                        ...
                        {item.p_contact_num==null?'- - - - - - - ':item.p_contact_num}
                             ...
                             <View style={{marginHorizontal: responsiveWidth(3),
                                 ...
                                 <View style={{flexDirection:'row',justifyContent:'space-between'
                                                ...
                                                <View style={{flexDirection:'row',alignSelf:'center'}}>
                                                    ...
                                                    <Text> / General /</Text>
                                                    <Text style={{color:'#F15A25'}}>Contacts</Text>
                                                    </Text>
                                 ...
                                 >
                                    <Text 
                                         ...
                                         {StaticWordsWeb.ContactsPage.header}
