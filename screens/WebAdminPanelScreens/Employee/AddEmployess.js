...
export default function AddEmployess({navigation}){
   

   
 
    const [joiningDate,setJoiningDate]=React.useState(); 
    const [nextAppraisaldate,setNextAppraisaldate]=React.useState(); 
                   ...
                   <View style={{flexDirection:'row', }}>           
                     ...
                     <View style={{marginHorizontal: responsiveWidth(3),
                          ...
                          <Text style={{fontWeight:'500'}}> 
                             ...
                             <Text> / Employees /</Text>
                             <Text style={{color:'#F15A25'}}>Add Employees</Text></Text>
                        ...
                        <Card style={{ 
                          ...
                          <ScrollView style={{paddingLeft:responsiveWidth(2),
                            ...
                            <Text style={{fontWeight:'700',fontSize:responsiveFontSize(1.5),
                              ...
                              {StaticWordsWeb.AdminPrevileges.AddEmployess.header}
                            </Text>
                            <View style={{
                                            marginTop:responsiveHeight(1),
                            ...
                            <View style={{
                                ...
                                <MuiPickersUtilsProvider utils={DateFnsUtils}> 
                                            ...
                                            <KeyboardDatePicker  // time picker for START TIME
                                                  ...
                                                  fullWidth
                                                  onChange={(value)=>{setNextAppraisaldate(value)}}
                                                  format="dd/MM/yyyy"
                                                  variant="dialog"
                                                  style={{ 
                                                          backgroundColor:'#fff',
...
class AppraiserNameDropDown extends React.Component {
  constructor(props) {
    super(props);
...
//                   )
  ...
  render() {
    ...
    const placeholder = {
      label: 'Please Select Appraiser Name ..',
      value: null,
      color:'#33333380'
...
class DesignationDropDown extends React.Component {
    constructor(props) {
      super(props);
