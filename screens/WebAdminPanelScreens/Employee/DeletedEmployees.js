...
export default function DeletedEmployees({navigation}){
                   ...
                   <View style={{flexDirection:'row', }}>           
                     ...
                     <View style={{//marginRight: responsiveWidth(-2),
                           ...
                           <View style={{flexDirection:'row',justifyContent:'space-between',alignItems:'center'}}> 
                            <View>
                             <Text style={{fontWeight:'500'}}> <Text onPress={()=>navigation.navigate('Home')}>Home</Text><Text> / Employees /</Text><Text style={{color:'#F15A25'}}>Deleted Employees</Text></Text>
                            </View>
